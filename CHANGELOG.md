...
- **`scripts/smoke-test.sh`** — `--skip-nominatim`, `--skip-osrm`, and `--skip-photon` flags (aligned with `prepare-data`); `make smoke-test ARGS='…'` forwards options
...
[1.5.1]: https://github.com/face0b1101/airgap-geo-stack/compare/v1.5.0...v1.5.1
[unreleased]: https://github.com/face0b1101/airgap-geo-stack/compare/v1.5.1...HEAD
